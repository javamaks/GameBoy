...
// Значения битов регистра прерываний
const Byte
INTERRUPT_VBLANK = 0,
INTERRUPT_LCDC = 1,
INTERRUPT_TIMER = 2,
...
// Идентификаторы клавиш геймпада
const int
A = 0,  // A
B = 18, // S
START = 25, // 
...
// Класс помощник для пары регистров
class Pair
{
private:
    Byte& high;
...
// Класс помощник для регистра памяти
